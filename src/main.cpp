...
uint256 hashGenesisBlock("0x000003a4de590c542321bec6bbf5b83771f1054819f6709d011e0d2855119dd8");
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
      ...
      //vMerkleTree: 3f66108684400d84e2ffb528360d534fa19ecaf47c7c4c2ca1d1352ec4a351ad
        ...
        // Genesis block
        const char* pszTimestamp = "GoodsX";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x44670a6e271e4e0b8c0922fccf3cbc3821f5fa6a692508670bec0052f6b1ad55"));
        block.print();
